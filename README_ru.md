...
## ST7789 3D-кубик (цветной)
Отрисовка вращающегося 3D-кубика на дисплее ST7789 240x240 с окрашенными гранями, рёбрами и счётчиком FPS.
...
+ 6 окрашенных граней (красный, жёлтый, зелёный, голубой, синий, пурпурный)
+ Отрисовка рёбер каркаса с оптимизацией через dirty-rect
+ Счётчик FPS в реальном времени
+ Настраиваемый размер кубика, поле зрения, скорость вращения
+ Тактовая частота SPI: 36 МГц

[Исходный код проекта](https://github.com/cx693/Learning_to_develop_STM32_using_Rust/blob/main/Dome/ST7789_cube3d_Color/src/main.rs)
